...
You will interact with a dataset of simple 3D shapes (spheres, cubes, cylinders) in metal or rubber, in different colors, sliding around on a flat tabletop and bumping into each other.
